...
感谢[若依](https://gitee.com/y_project)

本仓库为了配合[ruoyi-rust](https://gitee.com/wizount/ruoyi-rust)后台，对[RuoYi-Vue3](https://github.com/yangzongzhuan/RuoYi-Vue3.git)作一些极小的修改。
